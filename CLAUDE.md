...
- **boot-app**: Spring Boot 4 web application with actuator, JPA/H2, validation. Main class: `studio.sandlight.app.AppApplication`
...
- **Spring Boot 4**: Uses H2 in-memory database, profiles supported (`dev` profile available)
